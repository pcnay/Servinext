      ...
      $template_articulo =' 
        ...
        <form method="POST" class = "item">
          ...
          <div class = "p_25">
            ...
            <input type="text" name="marca" placeholder="Marca" value = "%s" required>  
            <input type="text" name="modelo" placeholder="Modelo" value = "%s" required> 
            <input type="text" name="num_serial" placeholder="Numero de Serie" value = "%s" 
						required>
